...
export default async function AddCreditPage({
  ...
  const { storeId, partnershipId } = params;
  ...
  async function handleAddCredit(formData: FormData) {
    'use server';
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Add Store Credit</h1>
      ...
      <form action={handleAddCredit} className="space-y-4 bg-white p-6 rounded-lg shadow">
        <div>
