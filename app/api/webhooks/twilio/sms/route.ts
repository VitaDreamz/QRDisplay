...
export async function POST(req: NextRequest) {
  try {
    ...
    if (body === 'HELP' || body === 'INFO') {
      return new Response(
        `<?xml version="1.0" encoding="UTF-8"?><Response><Message>SampleHound SMS Service. Reply STOP to unsubscribe or START to resubscribe. Need help? Email jbonutto@gmail.com or visit samplehound.com/contact</Message></Response>`,
        {
          headers: { 'Content-Type': 'text/xml' },
          status: 200
        }
