    ...
    >
      <div className="pb-20">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Choose Samples & Products</h1>
          <p className="text-gray-600">Select at least one sample and one full-size product offering</p>
        </div>
